      ...
      <section ref={heroRef} className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-4 sm:px-6 lg:px-8 z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center my-25">
            <h1 className="animate-hero text-4xl md:text-6xl font-extrabold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-blue-500 to-green-500">
              Elevate Your Academic Performance
            </h1>
            <p className="animate-hero text-base md:text-xl font-sans text-gray-400 max-w-3xl mx-auto mb-10">
              Track, analyze, and improve your academic journey with our cutting-edge performance analytics platform.
            </p>
            ...
            {[
              {
                ...
                description:
                  "Visualize your academic progress with intuitive charts and graphs that highlight strengths and areas for improvement.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description: "AI-powered study schedules tailored to your learning style, goals, and upcoming exams.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Set academic goals and track your progress with detailed metrics and milestone achievements.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Detailed breakdown of performance by subject, highlighting strengths and areas that need attention.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Get tailored suggestions for resources, study methods, and improvement strategies based on your data.",
                icon: (
                  <svg
                    className="w-10 h-10 text-pink-500"
                    fill="none"
              ...
              },
              {
                ...
                description:
                  "Connect with peers, form study groups, and share resources to enhance your learning experience.",
                icon: (
                  <svg
                    className="w-10 h-10 text-blue-500"
                    fill="none"
