  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 opacity-30">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-blue-500 blur-[100px] opacity-30"></div>
        <h1 className="text-9xl font-bold mx-10 my-10 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-blue-500 to-green-500">
          Be Among Us
        </h1>
      </div>
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="mt-8 bg-gray-900/80 backdrop-blur-sm p-8 rounded-xl border border-gray-800 shadow-xl">
          {errors.form && (
